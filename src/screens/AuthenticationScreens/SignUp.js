    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <ImageBackground source={require('../../../assets/vector_1.png')} style={styles.vector}>
                ...
                <View style={{ height: hp(15), width: wp(100), paddingHorizontal: '5%' }}>
                    <Text style={{ fontFamily: 'Nunito-Bold', fontSize: hp(3.6), color: '#14BA9C' }}>Start My BinIQ Profile</Text>
                    <Text style={{ fontFamily: 'Nunito-Regular', fontSize: hp(1.7), color: '#524B6B', marginTop: '5%' }}>Register your account today and gain access to comprehensive tools and resources designed to optimize your reselling journey.</Text>
                </View>
