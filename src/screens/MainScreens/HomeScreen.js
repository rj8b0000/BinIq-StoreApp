...
//       try {
//         const { api_key } = user || {};
//         if (!api_key) throw new Error("User not logged in or API key missing");

//         // Fetch Trending Products
//         const trendingRes = await axios.post(
//           "https://binq.paywin24.com/api/tranding-product",
//           {},
//           { headers: { apiToken: api_key, "Content-Type": "application/json" } }
//         );
//         if (trendingRes.data.success) {
//           setTrendingProducts([
//             {
//               id: trendingRes.data.tranding_product.id,
//               image: { uri: trendingRes.data.tranding_product.pic },
//               title: trendingRes.data.tranding_product.title,
//               description: trendingRes.data.tranding_product.description,
//               discountPrice: `$${trendingRes.data.tranding_product.offer_price}`,
//               originalPrice: `$${trendingRes.data.tranding_product.price}`,
//               totalDiscount: `${
//                 100 -
//                 Math.round(
//                   (trendingRes.data.tranding_product.offer_price /
//                     trendingRes.data.tranding_product.price) *
//                     100
//                 )
//               }% off`,
//             },
...
//           setActivityFeed(
//             activityRes.data.activity_feed_products.map((item) => ({
//               id: item.id,
//               image: { uri: item.pic },
//               title: item.title,
...
//           setPromotions(
//             promoRes.data.promotions_products.map((item) => ({
//               id: item.id,
//               image: { uri: item.pic },
//               title: item.title,
...
//         }
//       } catch (error) {
//         console.error("HomeScreen API error:", error.message);
//       } finally {
//         setIsLoading(false);
//       }
//     };
