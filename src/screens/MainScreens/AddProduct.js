...
const AddProduct = () => {
  ...
  const handleAddProduct = async () => {
    ...
    try {
      ...
      Alert.alert("Success", response.message, [
        { text: "OK", onPress: () => navigation.replace("AddProduct") },
      ]);
    } catch (error) {
  ...
  return (
    <ScrollView
      ...
      scrollEnabled={!openCategory && !openAddType} // Disable scroll when dropdown is open
    >
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={[styles.dropdownContainer, { zIndex: 600 }]}>
            <DropDownPicker
              ...
              setOpen={(isOpen) =>
                handleOpenDropdown(setOpenAddType, openAddType, "addType")
              }
              ...
              dropDownMaxHeight={hp(20)} // Adjusted for fewer items
            />
          </View>
          ...
          <View style={[styles.dropdownContainer, { zIndex: 500 }]}>
            <DropDownPicker
              ...
              disabled={isLoading}
              dropDownMaxHeight={hp(40)} // Allow scrolling with a max height
              scrollViewProps={{ showsVerticalScrollIndicator: true }} // Enable visible scroll bar
            />
          </View>
