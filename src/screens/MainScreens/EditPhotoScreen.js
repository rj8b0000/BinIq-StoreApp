        ...
        <ScrollView style={styles.container}>
            ...
            <ImageBackground source={require('../../../assets/vector_1.png')} style={styles.vector}>
                ...
                <View style={{ width: wp(100), paddingHorizontal: '5%' }}>
                    <Text style={{ fontFamily: 'Nunito-Bold', fontSize: hp(3), color: '#14BA9C' }}>Nike Sneakers</Text>
                </View>
                ...
                <TouchableOpacity style={styles.gettingStarted} onPress={() => navigation.navigate('UploadSuccess')}>
                    <Text style={{ fontFamily: 'Nunito-SemiBold', color: '#fff', fontSize: hp(2) }}>Save Changes</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.cancelBtn} onPress={() => navigation.navigate('UploadSuccess')}>
                    <Text style={{ fontFamily: 'Nunito-SemiBold', color: 'red', fontSize: hp(2.2) }}>Cancel</Text>
                </TouchableOpacity>
            </ImageBackground>
        </ScrollView>
    )
